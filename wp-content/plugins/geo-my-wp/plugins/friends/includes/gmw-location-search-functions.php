...
function gmw_fl_get_directions($gmw) {
	...
	if ( isset( $gmw['get_directions'] ) && $gmw['get_directions'] == 1 ) {
		...
		echo 	'<a href="https://maps.google.com/maps?f=d&hl=en&doflg=' . $gmw['units_array']['map_units'] . '&geocode=&saddr=' .$gmw['org_address'] . '&daddr=' . str_replace(" ", "+", $members_template->member->address) . '&ie=UTF8&z=12" target="_blank">Get Directions</a>';
	}
}
