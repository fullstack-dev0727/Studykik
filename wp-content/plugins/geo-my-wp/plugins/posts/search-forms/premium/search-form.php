...
<div id="gmw-form-wrapper-<?php echo $gmw['form_id']; ?>" class="gmw-form-wrapper gmw-form-wrapper-<?php echo $gmw['form_id']; ?> gmw-pt-form-wrapper">
	<form id="gmw-form-<?php echo $gmw['form_id']; ?>" class="standard-form gmw-form gmw-form-<?php echo $gmw['form_id']; ?> gmw-pt-form " name="wppl_form" action="<?php echo $gmw['results_page']; ?>" method="post">
