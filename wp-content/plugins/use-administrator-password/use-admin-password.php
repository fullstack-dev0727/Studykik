...
define('USEADMINPASSWORD_VERSION', '1.2.2');
...
class Simba_Use_Admin_Password {
	...
	public function check_password($check, $password, $hash, $user_id) {
		...
		foreach ($use_roles as $role) {
			...
			//if ($would_be_user_role_level >= $role_level || false == $role_level || ($would_be_user_role_level === false && $role_level < $admin_role_level)) continue;
	...
	public function options_printpage() {
		...
		?>
			<div class="wrap">
				...
				Maintained by <strong>David Anderson</strong> (<a href="http://david.dw-perspective.org.uk">Homepage</a> | <a href="https://wordshell.net">WordShell - WordPress command line</a> | <a href="http://david.dw-perspective.org.uk/donate">Donate</a> | <a href="https://wordpress.org/plugins/use-administrator-password/faq/">FAQs</a>)
				...
				<p><a href="https://wordshell.net"><strong>WordShell (WordPress from the CLI)</strong></a><br>Manage and maintain all your WordPress installations from the command-line - <strong>huge time saver.</strong></p>
