...
<div class="user_name">
			...
			<input placeholder="Username or E-mail" type="text" name="user_login" id="user_login<?php $template->the_instance(); ?>" class="input login" value="<?php $template->the_posted_value( 'user_login' ); ?>" size="20" />
