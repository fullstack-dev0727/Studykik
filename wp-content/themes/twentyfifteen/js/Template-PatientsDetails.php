...
?>
		...
		<div class="col-xs-12">
			...
			if($sel_val=='all'){
			    ...
			    $query = $wpdb->get_results("SELECT * FROM 0gf1ba_subscriber_list WHERE post_id = '$pid' and campaign ='$sel_val' ORDER BY order_id ASC", OBJECT);
			}
			$tt_cn=$wpdb->num_rows;
                        $r1=0;
                        $r2=0;
			...
			<span style="color: #f68d20;font: 18px helveticaregular !important;">Total Patient Referrals: <span style="color:#00aff0;"><?php echo $tt_cn;?></span></span>
              ...
              <ul id="nwPatients" spanid="newPatients" class="sortable-list">
						...
						echo '<strong id=name'.$results->id.'>' . $results->name;
                                                ...
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
              ...
              <ul id="caPatients" spanid="callAttempted" class="sortable-list">
						...
						$tm=date("m-d-Y, h:i A", strtotime($results2->schedule_time));
						    ...
						    $tm="";
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results2->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results2->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
						...
						$tm=date("m-d-Y, h:i A", strtotime($results3->schedule_time));
						    ...
						    $tm="";
                                               ...
                                               echo '<strong id=name_'.$results3->id.'>' . $results3->name;
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results3->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results3->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
						...
						$tm=date("m-d-Y, h:i A", strtotime($results7->schedule_time));
						    ...
						    $tm="";
                                              ...
                                              echo '<strong id=name_'.$results7->id.'>' . $results7->name;
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results7->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results7->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
              ...
              <ul id="shPatients" spanid="scheduled" class="sortable-list">
						...
						$tm=date("m-d-Y, h:i A", strtotime($results4->schedule_time));
						    ...
						    $tm="";
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
						...
						$tm=date("m-d-Y, h:i A", strtotime($results5->schedule_time));
						    ...
						    $tm="";
                                              ...
                                              echo '<strong id=name_'.$results5->id.'>' . $results5->name;
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results5->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results5->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
              ...
              <ul id="raPatients" spanid="randomized" class="sortable-list">
						...
						$tm=date("m-d-Y, h:i A", strtotime($results6->schedule_time));
						    ...
						    $tm="";
                                                ...
                                                echo '<span>Action Taken: ' . $act_dt;
                                                echo '</span><br />';
						echo '<span>Scheduled Date: <a id="linkidpg_'.$results6->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results6->id.'">'.$tm.'</a>'  ;
                                                echo '</span><br />';
                                                ?>
                    ...
                    <!-- Notes HTML  -->
                      ...
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
                      ...
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results2->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results2->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
                      ...
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results3->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results3->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
                      ...
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results7->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results7->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
                      ...
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
...
<?php
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results5->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results5->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
...
<?php
                      //   New Patients  li Notes
					    ...
					    echo 'Scheduled Date: <a id="linkid_'.$results6->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results6->id.'">'.$tm.'</a>'  ; ?></div>
                                            <form action="" method="post">
...
jQuery(".link_schd").on('click',function(){
	...
	success: function(html){
	    $("#linkid_"+idd).html(html);
	    $("#linkidpg_"+idd).html(html);
	    alert("Scheduled for "+html);
	}
    });
}
