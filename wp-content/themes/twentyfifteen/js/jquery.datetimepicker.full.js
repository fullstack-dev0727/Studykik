...
;(function (factory) {
	...
	$.fn.datetimepicker = function (opt) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"><p style="text-align: center; font-weight: bold; color: orange; font-size: 24px; text-decoration: underline;width:96%">Schedule Your Patient</p><a id="mtsitediv" href="javascript://void(0);" class="closepop" onclick="pickclose();">Close</a></div>'),
