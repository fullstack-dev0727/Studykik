<?php
/**
Template Name: Thank You Aweber WP Engine
 */
$v2_template_engine = false;
if(isset($_REQUEST['post_id']) && $_REQUEST['post_id'] !== ''){
    $post_id = $_REQUEST['post_id'];
    $v2_template_engine = (bool) get_post_meta( $post_id, 'v2_template_engine', true );
}

if(!$v2_template_engine){
get_header(); ?>
<?php //echo $newurl=get_permalink('32360');?>
<?php //if($newurl=='studykik.com/louisv/'){?>
<?php //echo $_GET['post_id'];die;
...
?>
<?php
if(in_array($_GET['post_id'],array(32360,59629,76112,79819)))
{
...
<div id="inner-page">
  <div class="container">
    <div class="sign_up">
      <?php //echo $body; ?>
<!--      <h3></h3>-->
         <?php if ( $_GET['post_id'] == 76112 || $_GET['post_id'] == 79819){
             echo '<h5>Thank you for Signing up!</h5>';
         }else{
             echo '<h5>Thank you for Signing up the StudyKIK "Magi East Sweepstakes"!<br/> One more step, check your email and share the link!</h5>';
         } ?>
...
<div id="inner-page">
  <div class="container">
    <div class="sign_up">
	  ...
	  {?>
		<h3>Dank u voor uw interesse in ons onderzoek.</h3>
      <h5>U kunt rechtstreeks contact opnemen voor informatie en/of een afspraak met PT&R op </h5>
      <span>046 4759431</span> <br/>
      <h5>Locatie: Elsstraat 47 – 6191JW Beek – Nederland</h5>
      <h2>We kijken naar uit naar uw medewerking.</h2>
      <br/>
      
	  <?php }else{?>
      
      <h3><?php echo _studykik_func_1($_custom_fields,'trans_thank_you_for_signing_up_for_our_research_study','Thank you for signing up for our research study!') ?></h3>
      <h5><?php echo _studykik_func_1($_custom_fields,'trans_please_call_us_to_schedule_your_appointment_at','Please call us to schedule your appointment at:') ?></h5>
      <h2><?php echo $name_of_site; ?></h2>
      <span><?php echo $phone_number; ?></span> <br/>
      <h5><?php echo _studykik_func_1($_custom_fields,'trans_here_is_the_study_location','Here is the study location:') ?></h5>
      <h2><?php echo $study_full_address; ?></h2>
      <br/>
      <?php if($website_url_thank_you_page){ ?>
      <h5>For more information about this study: <a href="<?php echo $website_url_thank_you_page; ?>">CLICK HERE</a></h5>
      <?php } ?>
      <h5><?php echo _studykik_func_1($_custom_fields,'trans_looking_forward_to_having_you_join','Looking forward to having you join.') ?></h5>
      <?php } ?>
...
<?php
    ...
    include 'page-aweberThankYou_v2.php';
}?>