...
?>
		...
		<div class="col-xs-12">
			...
			$tt_calls=0;
			    ...
			    if($qry->is_front == 1 && $qry->redirect_number != "" && $qry->broadcast_id != ""){
				$tt_calls=$tt_calls+1;
			    }
                        }
			if(empty($all_ids)){
			...
			<div style="width:50%;float:left;text-align:right;">
			    ...
			    <br>
			    <h2>
			    <a class="add_btn esite" href="javascript:void(0);" onclick="document.getElementById('esite').style.display = 'block';document.getElementById('fade').style.display = 'block'">Edit Site Information</a>
			    </h2><br/>
                            <h2><a class="add_btn" href="javascript:void(0);" onclick="document.getElementById('embed').style.display = 'block';document.getElementById('fade').style.display = 'block'">Add Patient</a></h2></h2>
                            ...
                            <?php }?>
				<?php
				$pr_no = get_post_meta($pid, 'purchased_number', true);
				if($pr_no !=""){
				?>
							
							<h2 style="float: right; width: 590px;margin-top:1px;">
                            <a class="add_btn textpatient" href="javascript:void(0);">Text Patient</a></h2>
							<?php } ?>
			...
			<?php
			if($red_num !="" && $red_num !=0 && $red_num !='0'){ ?>
			    <br>
			    <span style="color: #f68d20;font: 18px helveticaregular !important;">Total Calls: <span style="color:#00aff0;"><?php echo $tt_calls;?></span></span>
			<?php } ?>
		    </div>
		</div>
                ...
                <div id="center-wrapper">
                    ...
                    <div class="dhe-example-section" id="ex-2-3">
						...
						<div style="width: 100%; margin-bottom: 10px; margin-top: -30px;"><a style="color: red; margin-left: 4px;" class="questionchange_view" onclick="document.getElementById('embed13').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);">Any Questions?</a></div>
              ...
              <ul id="nwPatients" spanid="newPatients" class="sortable-list">
						...
						if($time_zone !=""){
						    ...
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
						
                                                ?>
												<div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													<a data-tooltip="<?php echo isset($query_notes[0]->notes) ? $query_notes[0]->notes : 'Add notes'; ?>" data-tooltip-position="top" onclick="document.getElementById('embed<?php echo $results->id; ?>').style.display = 'block';document.getElementById('fade').style.display = 'block'" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="replacenotes aaaa<?php echo $results->id; ?>" id="add_not"><img style="width: 22px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/notes_icon.png" /></a>
													<?php if ($redirect_num != '' && $results->is_front == 1 && $results->no_of_question !=0) { ?>
														<?php if ($results->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results->broadcast_id != "" && $redirect_num != '' && $results->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results->id; ?>" id="msgs_<?php echo $results->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results->id; ?>" id="msgs_<?php echo $results->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="caPatients" spanid="callAttempted" class="sortable-list">
						...
						if($time_zone !=""){
						    ...
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results2->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results2->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
					    ?>
                                                <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results2->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results2->is_front == 1 && $results2->no_of_question !=0) { ?>
														<?php if ($results2->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results2->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results2->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results2->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results2->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results2->broadcast_id != "" && $redirect_num != '' && $results2->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results2->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results2->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results2->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results2->id; ?>" id="msgs_<?php echo $results2->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results2->id; ?>" id="msgs_<?php echo $results2->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="nqPatients" spanid="notQualified" class="sortable-list">
						...
						if($time_zone !=""){
						    ...
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results3->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results3->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
                                                ?>
                                                <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results3->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results3->is_front == 1 && $results3->no_of_question !=0) { ?>
														<?php if ($results3->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results3->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results3->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results3->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results3->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results3->broadcast_id != "" && $redirect_num != '' && $results3->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results3->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results3->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results3->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results3->id; ?>" id="msgs_<?php echo $results3->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results3->id; ?>" id="msgs_<?php echo $results3->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="anPatients" spanid="actionNeeded" class="sortable-list">
						...
						if($time_zone !=""){
						    ...
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results7->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results7->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
                                                ?>
                                               <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results7->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results7->is_front == 1 && $results7->no_of_question !=0) { ?>
														<?php if ($results7->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results7->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results7->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results7->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results7->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results7->broadcast_id != "" && $redirect_num != '' && $results7->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results7->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results7->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results7->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results7->id; ?>" id="msgs_<?php echo $results7->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results7->id; ?>" id="msgs_<?php echo $results7->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="shPatients" spanid="scheduled" class="sortable-list">
						...
						if($time_zone !=""){
							...
							echo '</span><br />';
							echo '<span><a id="linkidpg_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>';
							echo '</span><br />';
						    }
						    else{
							echo '<span id="schspan_'.$results4->id.'"><a id="linkidpgsh_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">Schedule Date:</a> '  ;
							echo '</span><br />';
							echo '<span><a id="linkidpg_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>';
							echo '</span><br />';
						    }
						    echo '</span><br />';
                                                ...
                                                ?>
                                                    <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results4->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results4->is_front == 1 && $results4->no_of_question !=0) { ?>
														<?php if ($results4->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results4->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results4->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results4->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results4->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results4->broadcast_id != "" && $redirect_num != '' && $results4->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results4->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results4->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results4->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results4->id; ?>" id="msgs_<?php echo $results4->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results4->id; ?>" id="msgs_<?php echo $results4->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="cnPatients" spanid="consented" class="sortable-list">
						...
						if($time_zone !=""){
						    echo '<span id="schspan_'.$results->id.'">Schedule Date:'  ;
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results5->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results5->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
                                                ?>
                                           <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results5->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results5->is_front == 1 && $results5->no_of_question !=0) { ?>
														<?php if ($results5->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results5->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results5->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results5->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results5->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results5->broadcast_id != "" && $redirect_num != '' && $results5->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results5->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results5->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results5->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results5->id; ?>" id="msgs_<?php echo $results5->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results5->id; ?>" id="msgs_<?php echo $results5->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
              ...
              <ul id="raPatients" spanid="randomized" class="sortable-list">
						...
						if($time_zone !=""){
						    echo '<span id="schspan_'.$results->id.'">Schedule Date:'  ;
						    echo '</span><br />';
						    echo '<span><a id="linkidpg_'.$results6->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results6->id.'">'.$tm.'</a>';
						    echo '</span><br />';
						}
                                                ?>
                                          <div style="width: 100%;">
													<a href="<?php echo site_url();?>/patients-details/?pid=<?php echo $pid; ?>&delete=<?php echo $results6->id; ?>" onclick="return confirm('Are you sure you would like to delete contact?')" style="margin-left: 13px; float: right;" id="add_not"><img src="<?php bloginfo('template_url'); ?>/images-dashboard/close2.png" /></a>
													...
													<?php if ($redirect_num != '' && $results6->is_front == 1 && $results6->no_of_question !=0) { ?>
														<?php if ($results6->is_callfire_qualified != 1 ){?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results6->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results6->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Question.png" /></a>
														<?php
														}
														else{?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results6->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results6->id; ?>" id="add_not"><img  style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/QuestionGreen.png" /></a>
														<?php
														}
														?>
													<?php
														...
														if($results6->broadcast_id != "" && $redirect_num != '' && $results6->is_front == 1 ){ ?>
															<a data-tooltip="Add notes" data-tooltip-position="top" onclick="document.getElementById('patient<?php echo $results6->id; ?>').style.display='block';document.getElementById('fade').style.display='block'" href="javascript:void(0);" style="float: right; margin-left: 13px;" class="replacenotes aaaa<?php echo $results6->id; ?>" id="add_not"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Phone.png" /></a>
														<?php
													   }
													}
													?>
													<?php
													if (in_array($results6->phone,$is_read_arr)){ ?>
													<a unq_at="<?php echo $results6->id; ?>" id="msgs_<?php echo $results6->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/Message_new.png"></a>
													
													<?php
													}
													else{ ?>
														<a unq_at="<?php echo $results6->id; ?>" id="msgs_<?php echo $results6->id; ?>" data-tooltip="Show Messages" data-tooltip-position="top" href="javascript:void(0);" style="margin-left: 13px; float: right;" class="sent_msg"><img style="height:20px;width:20px;" src="<?php bloginfo('template_url'); ?>/images-dashboard/img/New_Message.png"></a>
														<?php }
														?>
				    ...
				    $redirect_num=$results->redirect_number;
						...
						echo '<span id="editspns_'.$results->id.'">Schedule Date:</span><a id="linkid_'.$results->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results->id.'">'.$tm.'</a>'  ; ?>
						<?php
						if($results->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results->id;?>">
					    ...
					    <?php } ?>
                                        ...
                                        echo date('m-d-Y h:i:s', strtotime($date_here))." (EST)"; ?> </dt>
                                                            <dd>
                                    ...
                                    <?php if ($redirect_num != '' && $results->is_front == 1) { ?>
                                        <div id="patient<?php echo $results->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
				    ...
				    $redirect_num=$results2->redirect_number;
					    ...
					    echo '<span id="editspns_'.$results2->id.'">Schedule Date:</span><a id="linkid_'.$results2->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results2->id.'">'.$tm.'</a>'  ; ?>
					    <?php
					    if($results2->schedule_time !=""){ ?>
						<a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results2->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results2->id;?>">
						    <img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						</a>
					    <?php } ?>
					    </div>
					    <?php } ?>
                                ...
                                document.getElementById('embed<?php echo $results2->id;?>').style.display = 'block'">Close</a> </div>
                                    <?php if ($redirect_num != '' && $results2->is_front == 1) { ?>
                                        <div id="patient<?php echo $results2->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
                                                        <?php if ($results2->no_of_question == 0 && $results2->broadcast_id !="") { ?>
                                                    <div style="padding:20px;padding-left:5px;font-size:20px;font-weight:bold;height:90px;">
							<?php
							    echo '<h5>';
							    if ($results2->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results2->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results2->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results2->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results2->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                            }
				    ...
				    $redirect_num=$results3->redirect_number;
						...
						echo '<span id="editspns_'.$results3->id.'">Schedule Date:</span><a id="linkid_'.$results3->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results3->id.'">'.$tm.'</a>'  ; ?>
						<?php
						if($results3->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results3->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results3->id;?>">
							<img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						    </a>
						<?php } ?>
						</div>
					    <?php } ?>
                                    ...
                                    <?php if ($redirect_num != '' && $results3->is_front == 1) { ?>
                                        <div id="patient<?php echo $results3->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
							...
							<?php
							    echo '<h5>';
							    if ($results3->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results3->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results3->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results3->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results3->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                            }
				    ...
				    $redirect_num=$results7->redirect_number;
						...
						echo '<span id="editspns_'.$results7->id.'">Schedule Date:</span><a id="linkid_'.$results7->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results7->id.'">'.$tm.'</a>'  ; ?>
						<?php
						if($results7->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results7->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results7->id;?>">
							<img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						    </a>
						<?php } ?>
						</div>
					    <?php } ?>
                                    ...
                                    <?php if ($redirect_num != '' && $results7->is_front == 1) { ?>
                                        <div id="patient<?php echo $results7->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
							...
							<?php
							    echo '<h5>';
							    if ($results7->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results7->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results7->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results7->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results7->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                            }
				    ...
				    $redirect_num=$results4->redirect_number;
						...
						if($results4->schedule_time !=""){ 
						    echo '<span id="editspns_'.$results4->id.'">Schedule Date:</span> <a id="linkid_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>'  ;
						}
						else{
						    echo '<span id="editspns_'.$results4->id.'"><a id="editsch_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">Schedule Date:</a></span> <a id="linkid_'.$results4->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results4->id.'">'.$tm.'</a>'  ; 
						}
						?>
						<?php
						if($results4->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results4->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results4->id;?>">
							<img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						    </a>
						<?php } ?>
						</div>
					    <?php } ?>
                                    ...
                                    <?php if ($redirect_num != '' && $results4->is_front == 1) { ?>
                                        <div id="patient<?php echo $results4->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
							...
							<?php
							    echo '<h5>';
							    if ($results4->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results4->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results4->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results4->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results4->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                            }
...
<?php
				    ...
				    $redirect_num=$results5->redirect_number;
						...
						echo '<span id="editspns_'.$results5->id.'">Schedule Date:</span><a id="linkid_'.$results5->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results5->id.'">'.$tm.'</a>'  ; ?>
						 <?php
						if($results5->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results5->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results5->id;?>">
							<img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						    </a>
						<?php } ?>
						</div>
					    <?php } ?>
                                    ...
                                    <?php if ($redirect_num != '' && $results5->is_front == 1) { ?>
                                        <div id="patient<?php echo $results5->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
							...
							<?php
							    echo '<h5>';
							    if ($results5->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results5->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results5->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results5->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results5->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                            }
...
<?php
				    ...
				    $redirect_num=$results6->redirect_number;
						...
						echo '<span id="editspns_'.$results->id.'">Schedule Date:</span><a id="linkid_'.$results6->id.'" href="javascript://void(0);" class="link_schd" unq_lnk="'.$results6->id.'">'.$tm.'</a>'  ; ?>
						 <?php
						if($results6->schedule_time !=""){ ?>
						    <a class="removeschedule" style="margin-left:10px;margin-top:-2px;position:absolute;" id="rmv_sch<?php echo $results6->id;?>" href="javascript:void(0);" unq_lnk="<?php echo $results6->id;?>">
							<img src="<?php bloginfo('template_url'); ?>/images-dashboard/delete.png">
						    </a>
						<?php } ?>
						</div>
					    <?php } ?>
                                    ...
                                    <?php if ($redirect_num != '' && $results6->is_front == 1) { ?>
                                        <div id="patient<?php echo $results6->id; ?>" class="white_content" style="cursor: auto; display: none;width:63% !important;">
                                            <div class="col-xs-12  notes_right">
                                                <div class="row">
                                                    <h2 style="text-decoration: underline">Call Connect</h2>
                                                </div>
							...
							<?php
							    echo '<h5>';
							    if ($results6->ivr_time != "") {
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">'.date("m-d-Y", strtotime($results6->ivr_time)).'</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">'.date("h:i:s A", strtotime($results6->ivr_time)).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Date:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
								echo '<div style="font-size: 20px; float: left; width: 32%;"><span style="font-weight:bold;">Time:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></div>';
                                                           ...
                                                           <?php if ($results6->call_duration != 0) {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">'.gmdate("i:s", $results6->call_duration).'</span></div>';
                                                            }
                                                            else {
                                                                echo '<div style="font-size: 20px; float: left; width: 36%;"><span style="font-weight:bold;">Call Duration:</span> <span style="color:#00afef;font-weight: bold;">Not Connected</span></span>';
                                                            }
							    echo "</h5>";
							?>
						    </div>
...
<!--        <div id="savepatient" class="white_content2" style="display: none;">
 ...
 <div id="sentmsg" class="white_content msg_popupcls" style="cursor: auto; display: none;  width: 33% !important;left: 32.5% !important;   border-radius: 0;">
    <div class="col-xs-12 col-md-12 notes_left">
        <div class="row">
          <h2>Messages</h2>
        </div>
    ...
    <a class="closepop" href="javascript:void(0);" onclick="document.getElementById('sentmsg').style.display='none';document.getElementById('fade').style.display='none';">Close</a>
</div>
...
<div id="embed13" class="white_content" style="cursor: auto; display: none;width:65% !important;left:17.5% !important;top:11.5% !important;;" >
    <div class="col-xs-12 col-md-12 notes_left">
        ...
        <div data-offset="0" data-target="#myNavbar" data-spy="scroll" class="scroll-area" id="nts_div" style="text-align:center;height:425px!important;margin-bottom:15px;">
    ...
    <a class="closepopvideo" href="javascript:void(0);" onclick="document.getElementById('embed13').style.display='none';document.getElementById('fade').style.display='none';">Close</a>
</div>
...
<script>
	...
	$("#shPatients").sortable({ // begin sortable
		...
		receive: function(event, ui) { // begin receive
			...
			var anc='<a unq_lnk="'+id+'" class="link_schd" href="javascript://void(0);" id="linkidpgsh_'+id+'" >Schedule Date:</a>';
			$("#schspan_"+id).html(anc);
			var anced='<a unq_lnk="'+id+'" class="link_schd" href="javascript://void(0);" id="editsch_'+id+'" >Schedule Date:</a>';
...
// Text patient 
  ...
  jQuery(".textpatient").on('click',function(){
	jQuery("#fade").show();
...
/* phone ajax */
  ...
  jQuery(".sent_msg").on('click',function(event, ui){
    ...
    jQuery(".esite").on('click',function(){
...
$(document).on('click','.removeschedule',function (){
	...
	success: function (data) {
	    ...
	    var anc='<a unq_lnk="'+unq_lnk+'" class="link_schd" href="javascript://void(0);" id="linkidpgsh_'+unq_lnk+'" >Schedule Date:</a>';
	    $("#schspan_"+unq_lnk).html(anc);
	    var anc='<a unq_lnk="'+unq_lnk+'" class="link_schd" href="javascript://void(0);" id="editsch_'+unq_lnk+'" >Schedule Date:</a>';
