...
<div id="inner-page">
  <div class="container">
    <div class="sign_up">
      <?php //echo $body; ?>
<!--      <h3></h3>-->
      <h5>Thank you for entering the StudyKIK "SCOPE Summit Sweepstakes"!<br/> One more step, check your email and share the link!</h5>
...
<div id="inner-page">
  <div class="container">
    <div class="sign_up">
      ...
      <h5 style="padding-top: 33px; color: #553333;padding-bottom:33px;">For more information please call 877.627.2509</h5>
