...
if(isset($_REQUEST['rewards'])){
	...
	if(isset($_REQUEST['user_id'])){
		...
		if($rewards_old !=$rews){
			...
			$rewards_datetime=date('Y-m-d H:i:s');
			$wpdb->query($wpdb->prepare("INSERT INTO `0gf1ba_rewards_details`(`id`, `user_id`, `activity_of_points`,`rewards_date_time`,`credit`,`debit`,`balance`,`is_last`) VALUES (NULL,'$uids','Manual input points','$rewards_datetime','$credit','$debit','$rews',1)",array()));
