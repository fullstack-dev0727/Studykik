...
mysqli_query($conn,"INSERT INTO `cron_testing`(`id`, `name`) VALUES (NULL,'cron working for callfire from live server')");
			...
			if($response['Call']['State']=='FINISHED'){
				if(isset($response['Call']['CallRecord'])){
                                        ...
                                        if(isset($response['Call']['CallRecord']['Duration'])){
                                            ...
                                            mysqli_query($conn,"UPDATE 0gf1ba_subscriber_list SET call_duration=$calltime WHERE id=$subcid");
					    $received_time=date('Y-m-d H:i:s',strtotime($response['Call']['CallRecord']['FinishTime']));
					    mysqli_query($conn,"UPDATE 0gf1ba_subscriber_list SET ivr_time='$received_time' WHERE id=$subcid");
                                        }
