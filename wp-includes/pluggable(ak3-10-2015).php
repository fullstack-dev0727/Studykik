...
$user7='mo.tan@studykik.com';
 $to.=",".$user_7;
        ...
        $user_id = get_current_user_id();
          ...
          $user_2 = get_user_meta( $user_id, 'emailadd2', true );
          $user_3 = get_user_meta( $user_id, 'emailadd3', true );
          $user_4 = get_user_meta( $user_id, 'emailadd4', true );
          $user_5 = get_user_meta( $user_id, 'emailadd5', true );
          $user_6 = get_user_meta( $user_id, 'emailadd6', true );
          if($user_2 !=''){
               $to.=",".$user_2;
          }
             if($user_3 !=''){
        ...
        if($userId !='')
        {
         $user_2 = get_user_meta( $userId, 'emailadd2', true );
          $user_3 = get_user_meta( $userId, 'emailadd3', true );
          $user_4 = get_user_meta( $userId, 'emailadd4', true );
          $user_5 = get_user_meta( $userId, 'emailadd5', true );
          $user_6 = get_user_meta( $userId, 'emailadd6', true );
          if($user_2 !=''){
               $to.=",".$user_2;
          }
             if($user_3 !=''){
